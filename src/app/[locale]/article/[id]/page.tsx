...
export default function ArticlePage() {
  ...
  // Get HTML content from translations
  const articleContent = t.raw(`articleContent${id}`)
          ...
          <header className="mb-8">
            ...
            <div className="flex items-center text-gray-600 dark:text-gray-400 space-x-4">
              <div className="flex items-center">
                ...
                <span className="text-sm">{t(`articleDate${id}`)}</span>
              </div>
            </div>
          </header>

          {/* Modified section with dangerouslySetInnerHTML */}
          <div 
